...
"ptt": "true"
	...
	//group target \\
const reply = (teks) => {
           XeonBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": `${ownername}`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./XeonMedia/theme/cheemspic.jpg`),"sourceUrl": `https://chat.whatsapp.com/KguOo9XsRTW2iESYuHzVX1`}}}, { quoted: m})
        }
...
if (q.includes('--help')) return reply(examkosong) 
  ...
  if (!isInventoriBuruan){ addInventoriBuruan(m.sender) }
     ...
     await XeonBotInc.send5ButImg(from, `` + '' + teksehmazeh, `© ${botname}`, XeonBotInc, [{"urlButton": {"displayText": "YouTube☣️","url": `${websitex}`}}])
  }
  break
        case 'userlimit': 
        if (isBan) return reply(mess.ban)	 			
...
break
	...
	reply(mess.wait)
            ...
            if (!args[0]) reply(`Use ${prefix}gitclone repo link\nExample: https://github.com/urgithubname/reponame`)
...
mediaType:1,
mediaUrl: 'https://i1.sndcdn.com/avatars-4mLwsDpViZS5gMcr-U5G2pw-t500x500.jpg',
sourceUrl: "https://i1.sndcdn.com/avatars-4mLwsDpViZS5gMcr-U5G2pw-t500x500.jpg"
}}
}
XeonBotInc.sendMessage(m.chat, buttonMessage, { quoted: m })
}
